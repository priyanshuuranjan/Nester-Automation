    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-20">
      ...
      <section className="relative py-16 bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Explore our world-class infrastructure, modern facilities, and professional 
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-white mb-12">Infrastructure at a Glance</h2>
