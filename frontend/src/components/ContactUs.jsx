  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({
        type: "error",
        message:
          "Sorry, there was an error sending your message. Please try again or contact us directly at Info@nesterautomation.com",
      });
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Get in touch with our automation experts. We're here to help
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Nester Automation India Private Limited
                        <br />
                        Khata No. 466, Mustil No.13 Kankrola, Mankdola,
                        <br />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              We'd love to meet you in person. Schedule a visit to our facility.
            </p>
          </motion.div>
