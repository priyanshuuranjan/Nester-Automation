      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-bold gradient-text mb-4">Nester Automation</h3>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Nester Automation India Private Limited is powered by a team of highly qualified technocrats and specialist engineers, each bringing extensive experience and expertise to deliver optimal engineering solutions.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-2 text-gray-300">
                <p>Nester Automation India Private Limited</p>
                <p>Khata No. 466, Mustil No.13 Kankrola, Mankdola,</p>
                <p>Garhi Harsaru Gurugram Haryana</p>
                <p className="mt-4">
                  <a href="mailto:Info@nesterautomation.com" className="hover:text-white transition duration-300">
            ...
            <div className="flex items-center justify-center md:justify-end">
              <img 
                src="./images/NesterLogo.png"
                alt="Nester Automation Logo"
